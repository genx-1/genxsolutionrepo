...
public class SelectOneByOneButtonInLoop {
	public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 1; i <= 15; i++) {
            ...
            String buttonLocator1 = "//label[@for='checkbox-1']";
            String buttonLocator2 = "//label[@for='checkbox-2']";
            String buttonLocator3 = "//label[@for='checkbox-3']";
            String buttonLocator4 = "//label[@for='checkbox-4']";
            ...
            WebElement radioButton4 = driver.findElement(By.xpath(buttonLocator4));
