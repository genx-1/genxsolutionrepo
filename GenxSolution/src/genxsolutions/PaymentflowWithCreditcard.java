...
public class PaymentflowWithCreditcard {
	public static void main(String[] args) throws InterruptedException {
        ...
        WebElement CreditCardCheckbox = driver.findElement(By.xpath("(//span[@class='checkmark'])[10]"));
        Thread.sleep(2000); 
        CreditCardCheckbox.click();
        Thread.sleep(10000);      
      
      
       /* WebElement cardElement = driver.findElement(By.xpath("//input[@autocomplete='cc-number']"));
        cardElement.click();
        Thread.sleep(1000);
        cardElement.sendKeys("5555 5555 5555 4444");
        Thread.sleep(1000);
        WebElement monthAndDate = driver.findElement(By.xpath("//input[@autocomplete='cc-exp']"));
        monthAndDate.sendKeys("1226");
        Thread.sleep(1000);
        WebElement CVC = driver.findElement(By.xpath("//input[@autocomplete='cc-csc']"));
        CVC.sendKeys("126");*/
